...
namespace MercuryBus.Messaging.Consumer
{
	...
	public interface IMessageConsumer
    {
	    ...
	    ///     The subscriber ID to use for this subscription. Multiple subscriptions
	    ///     using the same subscriber ID will result in a particular message being sent to only one of the subscribers.
	    /// </param>
